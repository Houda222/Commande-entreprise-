...
class GoGame:
    ...
    def process_frame(self, frame):
        ...
        # img = np.copy(self.transformed_image)
        # draw_lines(cluster_1, img)
        # # img = np.copy(self.transformed_image)
        # draw_lines(cluster_2, img)
        # # imshow_(img)
        ...
        print(self.not_moves)
        sgf_ = GoSgf('a', 'b', self.not_moves)
        # sgf_ = GoSgf('a', 'b', self.moves)
        # _, sgf_n = self.sgf.update_sgf(self.not_moves)
