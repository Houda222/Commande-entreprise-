...
class GoVisual:
    ...
    def drawBoard(self):
        ...
        if not self.last_move is None:
            ...
            cv2.circle(board, ((col+1)*square_size, (row+1)*square_size), circle_radius, color=(0,0,255), thickness=2) 
            cv2.circle(board, ((col+1)*square_size, (row+1)*square_size), circle_radius, color=stone_color, thickness=-1) 
    ...
    def initial_position(self):
        ...
        """
        self.initialize_param(len(self.game.get_sequence()))
